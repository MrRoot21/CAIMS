...
public class StudentUsersList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isConnectedtoInternet(this)) {
            Toast.makeText(this, "Please connect to internet to see list", Toast.LENGTH_SHORT).show();
        }
    ...
    public static boolean isConnectedtoInternet(@NonNull StudentUsersList context) {
